        ...
        <div id='aboutId' className="about">
            ...
            <div className="about__content">
                <div className="about__paragraph">
                    <h1>About Me</h1>
                    <p>
                        Hi There! I am a 19 years old passionate programmer! I've been coding since December. Currently studying at the Lebanese University (2nd year), I am a 
                        passionate about learning coding and full stack development. My journey started when I came across a youtube 
                        video talking about react.js and how it is becoming the most popular web framework in 2020; this got me instantly
